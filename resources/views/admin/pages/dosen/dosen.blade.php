...
@section('main')
    ...
    @can('isAdmin')
        <div class="">
            <a href="/admin/dosen/create" class="btn btn-primary my-3 col-1 d-inline-block" id="tambahDataDosen"
                    ...
                    <tr>
                        ...
                        <td>
                            @can('isAdmin')
                                ...
                                <a href="/admin/dosendetail/{{ $item->id }}" class="btn btn-info"
                                    id="detailDosen"><b>Detail</b></a>
                            @endcan
