    ...
    <form method="post" action="/admin/mahasiswa" enctype="multipart/form-data">
        ...
        <div class="width-75">
            ...
            <div class="mb-3">
                ...
                <br>
                <select name="prodi_id" class="form-select text-secondary @error('prodi_id') is-invalid @enderror" required>
                    <option value="-" class="form-control">Pilih Prodi</option>
                    @foreach ($data as $item)
                        <option value="{{ $item->id }}" @if (old('prodi_id') == $item->id) selected @endif>
